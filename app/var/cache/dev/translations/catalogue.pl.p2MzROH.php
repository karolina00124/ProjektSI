...
$catalogue = new MessageCatalogue('pl', array (
  ...
  'messages' => 
  array (
    'action_back_to_list' => 'Powrót',
    'action_view' => 'Wyświetl',
    'label_actions' => 'Operacje',
    'label_id' => 'Identyfikator',
    'label_kroki' => 'Kroki',
    'label_content' => 'Zawartość',
    'label_created_at' => 'Utowrzono',
    'label_skladniki' => 'Składniki',
    'label_tags' => 'Tagi',
    'label_title' => 'Tytuł',
    'label_updated_at' => 'Zmodyfikowano',
    'message_empty_list' => 'Lista jest pusta.',
    'title_record_list' => 'Lista Rekordów',
    'title_record_view' => 'Wyświetlanie rekordu',
    'title_przepis_details' => 'Przepis szczegóły #%id%',
    'title_przepis_list' => 'Lista przepisów',
  ),
));
