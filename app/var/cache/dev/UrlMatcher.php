...
return [
    ...
    [ // $dynamicRoutes
        ...
        188 => [[['_route' => 'przepis_show', '_controller' => 'App\\Controller\\PrzepisController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        214 => [[['_route' => 'record_show', '_controller' => 'App\\Controller\\RecordController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        243 => [
